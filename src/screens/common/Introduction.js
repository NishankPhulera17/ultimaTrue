...
const Introduction = ({navigation}) => {
    ...
    const descriptionImages=[require('../../../assets/images/dwamDescription.png'),require('../../../assets/images/rewardifyDescription.png'),require('../../../assets/images/genuinemarkDescription.png')]
